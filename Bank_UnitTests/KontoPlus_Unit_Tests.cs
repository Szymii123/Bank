...
namespace BankTests
{
    ...
    {
        [Test]
        public void KontoPlus_Constructor_ShouldInitializeCorrectly()
        {
            var konto = new KontoPlus("Testowy Klient", 100, 50);
        ...
        public void Wyplata_OnBlockedAccount_ShouldThrowException()
        {
            var konto = new KontoPlus("Testowy Klient", 100, 50);
            konto.BlokujKonto();
            ClassicAssert.Throws<InvalidOperationException>(() => konto.Wyplata(50));
        }
    }
}